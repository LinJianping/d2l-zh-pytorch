...
class Inception(nn.Module):
    ...
    def __init__(self, in_channels, c1, c2, c3, c4, **kwargs):
        ...
        # 线路2, 1 x 1卷积层, 3 x 3卷积层
        self.p2_1 = nn.Conv2d(in_channels, c2[0], kernel_size=1)
        self.p2_2 = nn.Conv2d(c2[0], c2[1], kernel_size=3, padding=1)
        
        # 线路3, 1 x 1卷积层, 5 x 5卷积层
        self.p3_1 = nn.Conv2d(in_channels, c3[0], kernel_size=1)
        self.p3_2 = nn.Conv2d(c3[0], c3[1], kernel_size=5, padding=2)
        
        # 线路4, 3 x 3MaxPooling层, 1 x 1卷积层
...
[
 {
  "name": "stdout",
  "output_type": "stream",
  "text": "training on cuda:0\nepoch 1, loss 0.0175, train acc 0.163, test acc 0.242, time 38.5 sec\nepoch 2, loss 0.0078, train acc 0.605, test acc 0.739, time 38.9 sec\nepoch 3, loss 0.0043, train acc 0.792, test acc 0.812, time 39.2 sec\nepoch 4, loss 0.0033, train acc 0.843, test acc 0.850, time 39.5 sec\nepoch 5, loss 0.0028, train acc 0.864, test acc 0.844, time 39.7 sec\n"
 }
]
```
